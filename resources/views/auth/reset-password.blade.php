...
<head>
    ...
    <title>Reset Password – Arterra Living</title>
...
<div class="page-wrapper">
    ...
    <div class="card">
        ...
        <div class="card-sub">Masukkan email, password baru, dan konfirmasi password untuk memperbarui kata sandi.</div>
        ...
        <form method="POST" action="{{ route('password.store') }}">
            ...
            <div class="field">
                ...
                <div class="input-wrap">
                    <input id="email" type="email" name="email" value="{{ old('email', $request->email) }}" placeholder="nama@contoh.com" required autofocus autocomplete="username">
