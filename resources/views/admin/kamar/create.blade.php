...
<section class="hero reveal">
    <div class="hero-content">
        ...
        <h1 class="hero-title">Tambah <em>Kamar</em></h1>
        <p class="hero-subtitle">
            Tambahkan kamar baru dengan tipe dan fasilitas yang jelas ke dalam sistem Arterra Living.
        </p>
    </div>
</section>
...
<section class="form-card reveal">
    ...
    <div class="form-header">
        ...
        <div class="form-title">Data Kamar Baru</div>
        <div class="form-subtitle">
            Isi data di bawah untuk mendaftarkan kamar baru dalam sistem Arterra Living.
        </div>
    </div>
        ...
        @endif
          ...
          <form method="POST" action="/admin/kamar"
                ...
                <select id="id_tipe" name="id_tipe" required>
                    @foreach($tipe as $t)
                        <option value="{{ $t->id_tipe }}"
                            {{ old('id_tipe') == $t->id_tipe ? 'selected' : '' }}>
                            {{ $t->tipe_kamar }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="input-group">
                ...
                <textarea id="fasilitas" name="fasilitas" placeholder="Contoh: Kasur, TV, Lemari" required>{{ old('fasilitas') }}</textarea>
            </div>
