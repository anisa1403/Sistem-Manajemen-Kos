...
<section class="hero reveal">
    <div class="hero-content">
        ...
        <h1 class="hero-title">Edit <em>Tipe Kamar</em></h1>
        <p class="hero-subtitle">
            Perbarui nama tipe dan harga kamar dengan cepat dan mudah.
        </p>
    </div>
</section>
...
<section class="form-card reveal">
    ...
    <div class="form-header">
        ...
        <div class="form-title">Detail Tipe Kamar</div>
        <div class="form-subtitle">
            Isi data di bawah untuk memperbarui informasi tipe kamar dalam sistem Arterra Living.
        </div>
    </div>
          ...
          <form method="POST" action="/admin/tipe-kamar/{{ $data->id_tipe }}"
            ...
            <div class="input-group">
                ...
                <input
                    ...
                    id="tipe_kamar"
                    name="tipe_kamar"
                    value="{{ old('tipe_kamar', $data->tipe_kamar) }}"
