...
<section class="hero reveal">
    <div class="hero-content">
        ...
        <h1 class="hero-title">Daftar <em>Tipe Kamar</em></h1>
        <p class="hero-subtitle">
            Kelola tipe kamar dengan harga kamar.
        </p>
...
<section class="table-card reveal" id="daftar_tipe_kamar">

    <div class="table-header">
        <div class="table-title-wrap">
            <small>Data Tipe Kamar</small>
            <div class="table-title">Seluruh Tipe Kamar</div>
            <div class="table-subtitle">
                Menampilkan seluruh tipe kamar yang telah tercatat dalam sistem Arterra Living.
            </div>
        </div>
        <div class="header-right">
            <div class="table-badge">Total: {{ $data->count() }}</div>
            <a href="/admin/tipe-kamar/create" class="btn-add">
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            ...
                            <form method="POST" action="/admin/tipe-kamar/{{ $tipe->id_tipe }}"
