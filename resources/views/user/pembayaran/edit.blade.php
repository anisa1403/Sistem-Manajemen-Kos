        ...
        <div class="page-hero-inner">
            ...
            <div>
                <h1 class="page-hero-title">
                    <span class="title-light">Edit</span>
                    <span class="title-gold">Pembayaran</span>
                </h1>

                <p class="page-hero-sub">
                    Perbarui data pembayaran dan bukti transfer apabila terdapat kesalahan pada data yang telah dikirim.
                </p>
            </div>
    ...
    <div class="payment-grid">
        ...
        <div class="section-card">
            ...
            <div class="info-list">
                ...
                <div class="info-item">
                    ...
                    <span>{{ $pembayaran->sewa->no_kamar }}</span>
                </div>
                ...
                <div class="info-item">
                    ...
                    <span>{{ $pembayaran->sewa->kamar->tipeKamar->tipe_kamar }}</span>
                </div>
                ...
                <div class="info-item">
                    ...
                    <span>
                        Rp {{ number_format($pembayaran->sewa->kamar->tipeKamar->harga,0,',','.') }}
                    </span>
                </div>
                ...
                <div class="info-item">
                    ...
                    <span>{{ $pembayaran->sewa->jumlah_bulan }} bulan</span>
                </div>
        ...
        <div class="section-card">
            ...
            <div class="card-header">
                ...
                <div>
                    <h2 class="card-title">Edit Pembayaran</h2>
                    <p class="card-sub">Perbarui data pembayaran Anda</p>
                </div>
            </div>

            <form method="POST"
                action="/user/pembayaran/{{ $pembayaran->id_pembayaran }}"
                ...
                <div class="form-group">
                    ...
                    <p class="form-hint">
                        Nominal pembayaran tidak dapat diubah.
                    </p>
                ...
                <div class="form-group">
                    ...
                    <div style="margin-bottom:15px;">
                        <p class="form-hint">Bukti transfer saat ini</p>
